<%@ Page Title="" Language="C#" MasterPageFile="MasterPage.master" AutoEventWireup="true" CodeFile="Copy of hotelcontent.aspx.cs" Inherits="webpages_hotelcontent" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
	...
	<div class="slider-wrap">
		<div id="main-photo-slider" class="csw">
			<div class="panelContainer">
				...
				<div class="panel" title="Panel 4">
					<div class="wrapper">
						<img src="slide_images/tempphoto-4.jpg" alt="temp" />
						<div class="photo-meta-data">
				...
				<div class="panel" title="Panel 5">
					<div class="wrapper">
						<img src="slide_images/tempphoto-5.jpg" alt="temp" />
						<div class="photo-meta-data">
		...
		<div id="movers-row">
			...
			<div><a href="#4" class="cross-link"><img src="slide_images/tempphoto-4thumb.jpg" class="nav-thumb" alt="temp-thumb" /></a></div>
			<div><a href="#5" class="cross-link"><img src="slide_images/tempphoto-5thumb.jpg" class="nav-thumb" alt="temp-thumb" /></a></div>
			<div><a href="#6" class="cross-link"><img src="slide_images/tempphoto-6thumb.jpg" class="nav-thumb" alt="temp-thumb" /></a></div>
		</div>
